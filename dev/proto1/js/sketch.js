...
function makestuff(){
	for (var i = 0; i < stuff.length; i++) {
		...
		var cubess = madestuff[i] = new THREE.Mesh( geometry, material );
			cubess.position.x = -cube.position.x;
			cubess.position.y = -cube.position.y;
			cubess.position.z = cube.position.z;


		scene.add( cubes, cubess );
